...
class Pdf_manpaymentreceipt extends TCPDF {
...
// set cell margins
        ...
        $txt2 = $detail_detail['OWNER_ADDRESS1'];
        $txt3 = $detail_detail['OWNER_ADDRESS2'];
        $txt4 = $detail_detail['OWNER_ADDRESS3'];
        $txt5 = $detail_detail['OWNER_ADDRESS4'];
        ...
        $charge_desc = '綜合修葺結算費 Comprehensive Renovation Scheme Fee';
...
//        $this->MultiCell(20, 5, $receiptno, 1, 'R', 0, 1, '', '', true);
        ...
        $this->MultiCell(2, 4, ":", 0, 'L', 0, 0, '', '', true);
        $this->MultiCell(100, 4, "支票 Cheque", 0, 'L', 0, 0, '', '', true);
