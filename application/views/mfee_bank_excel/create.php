<?php $mode_create = array('comm_bank_excel', 'mfeecreate'); ?>
        ...
        <div class="col-sm-12">
            ...
            <form id="addForm" class="form-horizontal"  role="form" method="post" action="<?php echo site_url($mode_create) ?>" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="cat1"><?php echo $this->lang->line('genmfree_cat'); ?></label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <select class="form-control" name ="bankacno" >
                            <option value=""> </option>
                ...
                <input type="hidden" name="item" value="comm_bank_excel"/>
            </form>
        </div> 
    </div>
</div>
