...
//                                "<P>" + "NAME 姓名:" + getContact_first.FIRSTNAME + " " + getContact_first.LASTNAME + "</P>" +
//                                "<P>" + "UNIT 單位:" + getContact_first.UNIT + "</P>" +
//                                "<P>" + "FLOOR 樓層:" + getContact_first.FLOOR + "</P>" +
//                                "<P>" + "BLOCK 座數:" + getContact_first.BLOCK + "</P>" +
//                                "<P>" + "BUILDING 大廈:" + getContact_first.BUILDING + "</P>";
...
<script>
    ...
    function check_test() {
        ...
        //document.getElementById("remarks").value = checkbox_value.length;
