...
<?php $mode_create = array('ownercarpark_driver', 'create'); ?>
            ...
            <form id="addForm" class="form-horizontal"  role="form" method="post" action="<?php echo site_url($mode_create) ?>" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <input type="text" name="code" class="form-control" id="code" value="<?php echo $code; ?>">
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-sm-2" for="propertycode"><?php echo $this->lang->line('carparkowner_propertycode'); ?></label>
                    <div class="col-sm-4 col-sm-offset-right-6">
