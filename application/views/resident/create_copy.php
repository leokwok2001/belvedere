            ...
            <form id="addForm" class="form-horizontal"  role="form" method="post" action="<?php echo site_url($mode_create) ?>" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <input type="text" name="payment_ref" class="form-control" id="payment_ref" value="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <input type="text" name="code" class="form-control" id="code" value="<?php echo $payment['CODE']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <input type="text" name="amt" class="form-control" id="amt" value="<?php echo $outstanding['P_OUTSTAND']; ?>" >
                    </div>
                </div>
