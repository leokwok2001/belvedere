...
<?php $mode_create = array('comm_man_payment', 'edit'); ?>
            ...
            <form id="addForm" class="form-horizontal"  role="form" method="post" action="<?php echo site_url($mode_create) ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <input type="text" name="seq" class="form-control" id="seq" value="<?php echo $comm_man_payment['PAYMENTNO']; ?>" readonly="true" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <input type="text" name="code" class="form-control" id="code" value="<?php echo $comm_man_payment['CODE']; ?>" readonly="true" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">          
                        <div class="input-group input-append date" id="datePicker1">
                            <input type="text" name="indate" class="form-control" id="indate" value="<?php echo $comm_man_payment['INDATE']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <input type="text" name="amt" class="form-control" id="amt" value="<?php echo $comm_man_payment['AMT']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6" id="ptype">
                        <select class="form-control" name ="ptype">
                            ...
                            <option value="0" <?php if ($comm_man_payment['PAYTYPE'] === '0') echo 'selected'; ?> >Cheque</option>
                            <option value="1" <?php if ($comm_man_payment['PAYTYPE'] === '1') echo 'selected'; ?> >Autopay</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6" id="cheqno">
                        <input type="text" name="cheqno" class="form-control" id="cheqno" value="<?php echo $comm_man_payment['CHEQNO']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6" id="bankno">
                        <input type="text" name="bankno" class="form-control" id="bankno" value="<?php echo $comm_man_payment['BANKNO']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                     <label class="control-label col-sm-2" for="bankacno"><?php echo $this->lang->line('payment_bankacno'); ?></label>
                        ...
                        <input type="text" name="bankacno" class="form-control" id="bankacno"  value="<?php echo $comm_man_payment['BANKACNO']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <textarea  rows="4" cols="50" name="remarks" class="form-control" id="remarks"><?php echo $comm_man_payment['REMARKS']; ?> </textarea>
                    </div>
                </div>
