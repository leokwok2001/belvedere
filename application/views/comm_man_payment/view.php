<div class="container-fluid">    
    <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><a href="#"><?php echo $this->lang->line('menu07'); ?></a></li>
        <li class="active"><?php echo $this->lang->line('menu071'); ?></li>
    </ol>
</div>

<?php $mode_create = array('comm_man_payment', 'create'); ?>
<?php $mode_edit = array('comm_man_payment', 'edit'); ?> 
<?php $mode_update_status = array('comm_man_payment', 'update_status2'); ?> 
<?php $mode_unpresentcheque = array('comm_man_payment', 'unpresent_cheque'); ?> 
<?php $mode_view = array('comm_man_payment', 'view'); ?> 
...
<form id="listform" class="form-horizontal" role="form" method="post" action="<?php echo site_url($mode_view); ?>">               
            ...
            <tbody>
                ...
                <?php foreach ($payment as $payment_item): ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            if ($payment_item['IS_PAID'] == 1) {
                                echo '<span class="glyphicon glyphicon-ok"></span> ';
                            }
                            if ($payment_item['IS_PAID'] == 0) {
...
<form class="form-horizontal" role="form" method="post" action="<?php echo site_url($mode_create); ?>">                
    <div class="form-group">        
        <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" class="btn btn-default">
                <span class="glyphicon glyphicon-plus-sign"></span> <?php echo $this->lang->line('payment_create'); ?></button>
        </div>
    </div>
    <input type="hidden" name="item" value="payment"/>
</form>        
