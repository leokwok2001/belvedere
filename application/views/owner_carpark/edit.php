...
<?php $mode_edit3 = array('carpark', 'edit'); ?> 
<?php $mode_edit5 = array('carpark', 'unlink'); ?> 
<?php $mode_create = array('owner', 'edit'); ?>
<?php $mode_create3 = array('carparkowner', 'create/' . $owner['CODE']); ?>
<?php $mode_create4 = array('propertyowner', 'create/' . $owner['CODE']); ?>
    ...
    <div class="row">
        <div class="col-sm-12"></a>
            ...
            <ul class="nav nav-pills">
                ...
                <li>
                    <a data-toggle="tab" href="#menu2"><?php echo $this->lang->line('owner_tab_carpark'); ?></a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div id="menu2" class="tab-pane fade">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="<?php echo site_url($mode_create3); ?>">                
                     ...
                     <thead>
                            <tr>
                                <td><?php echo $this->lang->line('carpark_create'); ?></td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($carpark as $carpark_item): ?>
                                <tr>
                                    <td>
                                        <?php echo "<a href='" . site_url($mode_edit3) . "/" . $carpark_item['CARPARKCODE'] . "'>" . $carpark_item['CARPARKCODE'] . " </a>"; ?>  | 
                                        | 
                                        <?php echo "<a href='" . site_url($mode_edit5) . "/" . $carpark_item['CARPARKCODE'] . "/" . $owner['CODE'] . "'>" . "unlink" . " </a>"; ?>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
