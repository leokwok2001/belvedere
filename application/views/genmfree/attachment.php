...
<?php $mode_create = array('genmfree_attachment', 'create_pdf'); ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form id="addForm" class="form-horizontal"  role="form" method="post" action="<?php echo site_url($mode_create) ?>" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="code"><?php echo $this->lang->line('mfreestatment_res_code_from'); ?></label>
                    <div class="col-sm-4 col-sm-offset-right-6">
                        <input type="text" name="res_code_from" class="form-control" id="res_code_from" /> 
                   
                    </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="code"><?php echo $this->lang->line('mfreestatment_res_code_to'); ?></label>
                    <div class="col-sm-4 col-sm-offset-right-6">
                               <input type="text" name="res_code_to" class="form-control" id="res_code_to"  />
